...
public class CinemaTabFragment extends Fragment {
    ...
    private Subscriber<List<Cinema>> subscriber;
...
//        frameLayout.setId(frameId);
    ...
    public void displayCinemaList(final LayoutInflater inflater) {
        handlerFDS.post(new Runnable() {
            @Override
            public void run() {
                subscriber = new Subscriber<List<Cinema>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(List<Cinema> object) {
...
//                }
                ...
                new CinemaFeedDataStore(getContext()).getCinemaList().subscribe(subscriber);
            }
        });
    }
